                ...
                <div className="flex items-start justify-between text-xs">
                  ...
                  {order.shippingAddress ? (
                    <div className="text-right space-y-0.5 text-(--eerie-black)">
                      ...
                      <p className="">{order.shippingAddress.addressLine1}</p>
                      {order.shippingAddress.addressLine2 && <p className="">{order.shippingAddress.addressLine2}</p>}
                      <p className="">{order.shippingAddress.city}, {order.shippingAddress.postcode}</p>
                    </div>
                  ) : (
            ...
            <div className="bg-white border border-(--cultured) rounded-sm overflow-hidden h-full">
              ...
              <div className="p-4 space-y-5">
                ...
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="px-2 py-0.5 bg-green-100 text-green-700 rounded text-[10px] font-medium uppercase">Paid</span>
                </div>
