  ...
  return (
    <main className="bg-gray-50 min-h-screen" style={{ paddingTop: '100px', paddingBottom: '80px', paddingLeft: '20px', paddingRight: '20px' }}>
      <div className="container max-w-6xl mx-auto">
        <h1 className="text-3xl text-gray-900 mb-8" style={{ fontSize: '30px', fontWeight: 600, color: '#111827', marginBottom: '32px' }}>My Account</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden" style={{ borderRadius: '16px', border: '1px solid #f3f4f6', backgroundColor: '#fff' }}>
              <nav className="p-3" style={{ padding: '12px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
                <button 
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', borderRadius: '8px', color: activeTab === 'overview' ? '#fff' : '#4b5563', backgroundColor: activeTab === 'overview' ? '#111827' : 'transparent', fontWeight: 400 }}
                ...
                <button 
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', borderRadius: '8px', color: activeTab === 'orders' ? '#fff' : '#4b5563', backgroundColor: activeTab === 'orders' ? '#111827' : 'transparent', fontWeight: 400 }}
                ...
                <button 
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', borderRadius: '8px', color: activeTab === 'addresses' ? '#fff' : '#4b5563', backgroundColor: activeTab === 'addresses' ? '#111827' : 'transparent', fontWeight: 400 }}
                ...
                <button 
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', borderRadius: '8px', color: activeTab === 'settings' ? '#fff' : '#4b5563', backgroundColor: activeTab === 'settings' ? '#111827' : 'transparent', fontWeight: 400 }}
                ...
                <button 
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', borderRadius: '8px', color: '#dc2626', fontWeight: 400, backgroundColor: 'transparent' }}
          ...
          <div className="md:col-span-3">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 min-h-[500px]" style={{ padding: '32px', borderRadius: '16px', border: '1px solid #f3f4f6', backgroundColor: '#fff', minHeight: '500px' }}>
              ...
              {activeTab === "orders" && (
                <div className="animate-in fade-in duration-300">
                  <h2 className="text-2xl mb-6" style={{ fontSize: '24px', fontWeight: 600, marginBottom: '24px', color: '#111827' }}>Order History</h2>
              ...
              {activeTab === "addresses" && (
                <div className="animate-in fade-in duration-300">
                  <h2 className="text-2xl mb-6" style={{ fontSize: '24px', fontWeight: 600, marginBottom: '24px', color: '#111827' }}>Saved Addresses</h2>
                  <div className="text-center py-12" style={{ textAlign: 'center', padding: '48px 0' }}>
                     <MapPin size={48} className="mx-auto text-gray-300 mb-4" style={{ margin: '0 auto 16px auto', color: '#d1d5db' }} />
                     <h3 className="text-lg text-gray-900 mb-1" style={{ fontSize: '18px', fontWeight: 500, color: '#111827', marginBottom: '4px' }}>No addresses saved</h3>
                     <p className="text-gray-500" style={{ color: '#6b7280', fontWeight: 400 }}>You haven't saved any delivery addresses yet.</p>
                  </div>
                </div>
              )}
              ...
              {activeTab === "settings" && (
                <div className="animate-in fade-in duration-300">
                  <h2 className="text-2xl mb-6" style={{ fontSize: '24px', fontWeight: 600, marginBottom: '24px', color: '#111827' }}>Account Settings</h2>
