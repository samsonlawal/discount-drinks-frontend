...
const HeaderAuthUI = (() => {
  ...
  const updateAuthUI = () => {
    ...
    const signInBtn = document.querySelector('.header-action-btn:has([name="person-outline"])');
    if (!signInBtn) return;
    ...
    if (user) {
      ...
      if (icon && label) {
        ...
        // Change behavior to show dropdown
  ...
  const toggleUserMenu = () => {
    ...
    menu.innerHTML = `
      <div class="user-menu-header">
        <p class="user-menu-email">${escapeHTML(user.email)}</p>
      </div>
      <ul class="user-menu-list">
        <li><a href="#" class="user-menu-link"><ion-icon name="person-outline"></ion-icon> My Account</a></li>
        <li><a href="#" class="user-menu-link"><ion-icon name="receipt-outline"></ion-icon> Orders</a></li>
        <li><a href="#" class="user-menu-link"><ion-icon name="heart-outline"></ion-icon> Wishlist</a></li>
        <li><a href="#" class="user-menu-link"><ion-icon name="settings-outline"></ion-icon> Settings</a></li>
        <li class="user-menu-divider"></li>
        <li><button class="user-menu-link user-menu-logout" data-logout-btn><ion-icon name="log-out-outline"></ion-icon> Sign Out</button></li>
      </ul>
    `;
